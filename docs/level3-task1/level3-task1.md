...
<img src="assets/level3task1.gif" width="265" height="450"/>
...
<img src="assets/fragment_start.png" width="265" height="450"/>

- Alter the `fragment_start.xml` so that it matches the image. 
...
Positive
: You can use the <RatingBar> element for the stars
